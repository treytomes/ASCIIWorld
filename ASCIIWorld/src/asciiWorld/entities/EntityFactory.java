...
public class EntityFactory {
	...
	public static Entity createWaterEntity(Chunk chunk, int x, int y) throws Exception {
	...
	public static Entity createSandEntity(Chunk chunk, int x, int y) throws Exception {
		Entity entity = new Entity();
		entity.setName("Sand");
	...
	public static Entity createDirtEntity(Chunk chunk, int x, int y) throws Exception {
		Entity entity = new Entity();
		entity.setName("Dirt");
	...
	public static Entity createGrassEntity(Chunk chunk, int x, int y) throws Exception {
		Entity entity = new Entity();
	...
	public static Entity createStoneEntity(Chunk chunk, int x, int y) throws Exception {
		Entity entity = new Entity();
	...
	public static Entity createCaveEntranceEntity(Chunk chunk, int x, int y) throws Exception {
		Entity entity = new Entity();
	...
	public static Entity createTreeEntity(Chunk chunk, int x, int y) throws Exception {
		Entity entity = new Entity();
		entity.setName("Tree");
