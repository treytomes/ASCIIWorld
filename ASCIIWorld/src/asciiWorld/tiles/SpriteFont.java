...
public class SpriteFont {
	...
	public SpriteFont(String fontFile, Image fontImage) throws Exception {
		this(fontFile, fontImage, NO_HINT);
	}
	
	public SpriteFont(String fontFile, Image fontImage, int hint) throws Exception {
		this(new FileInputStream(fontFile), fontImage, hint);
	}
	...
	public SpriteFont(InputStream fontFile, Image fontImage, int hint) throws SlickException {
		...
		try {
			...
			BufferedReader in = new BufferedReader(new InputStreamReader(fontFile));
